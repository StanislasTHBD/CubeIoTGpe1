...
- Retrouver la liste de toutes les requêtes

		http://192.168.43.60:5000/api/v1/utilisateurs/
		-----------------------------------------------------------------
		http://192.168.43.60:5000/api/v1/utilisateur/ajouter/
		-----------------------------------------------------------------
		http://192.168.43.60:5000/api/v1/utilisateur /modifier
		-----------------------------------------------------------------
		http://192.168.43.60:5000/api/v1/utilisateur/supprimer/${id}
		-----------------------------------------------------------------
		http://192.168.43.60:5000/api/v1/donnees/
		-----------------------------------------------------------------
		http://192.168.43.60:5000/api/v1/donnees/humidite/{id}
		-----------------------------------------------------------------
		http://192.168.43.60:5000/api/v1/donnees/temperature/{id}
		-----------------------------------------------------------------
		http://192.168.43.60:5000/api/v1/donnee/ajouter/
		-----------------------------------------------------------------
		http://192.168.43.60:5000/api/v1/donnee/modifier
		-----------------------------------------------------------------
		http://192.168.43.60:5000/api/v1/donnee/supprimer/${id}
		-----------------------------------------------------------------
		http://192.168.43.60:5000/api/v1/capteurs/
		-----------------------------------------------------------------
		http://192.168.43.60:5000/api/v1/capteur/ajouter/
		-----------------------------------------------------------------
		http://192.168.43.60:5000/api/v1/capteur/modifier
		-----------------------------------------------------------------
